...
def atualizar_portal():
    ...
    # Processamos apenas 3 por fonte para garantir estabilidade e velocidade
    for entry in feed.entries[:3]:
        ...
        # PONTO CHAVE: Pequena pausa de 1 segundo para não estourar o limite da API
        time.sleep(1) 
        ...
        gerar_pagina_individual(id_n, data, cat)
